...
```
// 只更新 .dat 資料檔
# bash <(curl -L https://raw.fastgit.org/v2fly/fhs-install-v2ray/master/install-dat-release.sh)
```

### 移除 V2Ray

```
# bash <(curl -L https://raw.fastgit.org/v2fly/fhs-install-v2ray/master/install-release.sh) --remove
```
